  ...
  return (
    <Backdrop onClick={handleClose}>
      <motion.div
        ...
        className="modal z-50 relative orange-gradient bg-white mx-auto max-w-screen-md w-full md:w-[calc(100%-48px)] h-full md:h-auto md:max-h-[calc(100%-48px)] md:rounded-md"
        variants={dropIn}
        initial="hidden"
        animate="visible"
        exit="exit"
